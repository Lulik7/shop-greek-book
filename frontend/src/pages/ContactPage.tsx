...
const ContactPage = () => {
    ...
    return (
        <Box sx={{ fontFamily: '"Cormorant Garamond", serif', bgcolor: '#F8F5EE', minHeight: '100vh' }}>
            ...
            {/* HERO */}
            <Box sx={{
                position: 'relative', bgcolor: '#0B1F3A',
                py: { xs: 8, md: 12 }, overflow: 'hidden', textAlign: 'center',
            }}>
                <Box component="video" autoPlay muted loop playsInline sx={{
                    position: 'absolute', inset: 0, width: '100%', height: '100%',
                    objectFit: 'cover', zIndex: 0, opacity: 0.18, mixBlendMode: 'lighten',
                }}>
                ...
                <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
                    <Typography sx={{
                        fontFamily: '"Cinzel", serif', fontSize: '0.7rem', letterSpacing: '0.35em',
                        color: '#C9A84C', mb: 3, animation: `${fadeUp} 0.8s ease 0.1s both`,
                    }}>
                        СВЯЖИТЕСЬ С НАМИ
                    </Typography>
                    ...
                    <Box sx={{
                        width: 0, height: '2px', mx: 'auto', mb: 4,
                    ...
                    <Typography sx={{
                        ...
                        animation: `${fadeUp} 0.8s ease 1.8s both`, opacity: 0,
                    }}>
                    ...
                    <Typography sx={{
                        ...
                        letterSpacing: '0.15em', mt: 1,
                        animation: `${fadeUp} 0.8s ease 2s both`, opacity: 0,
                    }}>
                        ...
                        {contacts.map((c, i) => (
                            <Grid key={c.title} size={{ xs: 12, sm: 6, md: 3 }}>
                                <Box sx={{
                                    ...
                                    <Typography sx={{ fontSize: '1.8rem', mb: 1.5 }}>{c.icon}</Typography>
                                    <Typography sx={{
                                        fontFamily: '"Cinzel", serif',
                                    ...
                                    {c.lines.map((line, j) => (
                                        <Typography key={j} sx={{
                                            fontFamily: '"Lato", sans-serif',
                                            fontSize: '0.9rem', color: '#3A5A82', lineHeight: 1.8,
                                        }}>
                                            {line}
                                        </Typography>
                                    ))}
            ...
            <Box ref={wisdomRef} sx={{ bgcolor: '#0B1F3A', py: { xs: 6, md: 8 }, position: 'relative', overflow: 'hidden' }}>
                ...
                <Container maxWidth="lg" sx={{ position: 'relative' }}>
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', mb: 2 }}>
                        {'Мудрость древних'.split('').map((char, i) => (
                            <Box key={i} component="span" sx={{
                                ...
                                animation: wisdomInView
                                    ? `${charAppear} 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) ${i * 0.08}s forwards`
                                    : 'none',
                                textShadow: '0 2px 20px rgba(201,168,76,0.3)',
                                ...(char === ' ' && { minWidth: '0.4em' }),
                            }}>
                    ...
                    <Box sx={{
                        width: wisdomInView ? undefined : 0, height: '2px', mx: 'auto', mb: 5,
                        background: 'linear-gradient(90deg, transparent, #C9A84C, transparent)',
                        opacity: wisdomInView ? undefined : 0,
                        animation: wisdomInView ? `${drawLine} 1s ease 1.3s forwards` : 'none',
                    }} />
                    <Grid container spacing={3}>
                        {quotes.map((q, i) => (
                            <Grid key={i} size={{ xs: 12, sm: 6, md: 4 }}>
                                <Box sx={{
                                    height: 160, perspective: '1000px',
                                    ...
                                    <Box className="flip-inner" sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Typography sx={{
                                                ...
                                                color: '#C9A84C', mb: 1, lineHeight: 1.4,
                                            }}>
                                                {q.text}
                                            </Typography>
                                            <Typography sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            p: 3, textAlign: 'center', bgcolor: '#C9A84C',
                                            display: 'flex', flexDirection: 'column',
                                            alignItems: 'center', justifyContent: 'center',
                                        }}>
                                            <Typography sx={{
                                                ...
                                                color: '#0B1F3A', mb: 1, fontWeight: 600,
                                            }}>
                                                {q.translation}
                                            </Typography>
                                            <Typography sx={{
                                                fontFamily: '"Lato", sans-serif',
                                                fontSize: '0.6rem', color: 'rgba(11,31,58,0.6)',
                                                letterSpacing: '0.1em',
                                            }}>
                                                {q.author}
                                            </Typography>
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    background: 'linear-gradient(to bottom, rgba(11,31,58,0.6) 0%, rgba(11,31,58,0.3) 50%, rgba(11,31,58,0.7) 100%)',
                }} />
                ...
                <Container maxWidth="sm" sx={{ position: 'relative', zIndex: 2 }}>
                    ...
                    {sent ? (
                        <Box sx={{
                            ...
                            <Typography sx={{
                                fontFamily: '"Cormorant Garamond", serif',
                                fontSize: '1.6rem', color: '#F8F5EE', fontWeight: 600,
                            }}>
                                Сообщение отправлено!
                            </Typography>
                            <Typography sx={{
                                fontFamily: '"Lato", sans-serif',
                                fontSize: '0.9rem', color: 'rgba(248,245,238,0.6)', mt: 1,
                            }}>
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                                <TextField
                                    label="Ваше имя" value={form.name}
                                    onChange={e => setForm({ ...form, name: e.target.value })}
                                    fullWidth variant="outlined"
                                    sx={{
                                        '& .MuiOutlinedInput-root': {
                                            borderRadius: 0, fontFamily: '"Lato", sans-serif',
                                            color: '#F8F5EE',
                                ...
                                />
                                <TextField
                                    label="Ваше сообщение" value={form.message}
                                ...
                                <Button onClick={handleSubmit} variant="contained" sx={{
                                    bgcolor: '#C9A84C', color: '#0B1F3A', py: 1.5,
